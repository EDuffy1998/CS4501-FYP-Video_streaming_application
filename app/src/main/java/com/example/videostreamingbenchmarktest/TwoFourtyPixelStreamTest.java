 ...
 */
public class TwoFourtyPixelStreamTest extends AppCompatActivity {

    VideoView videoView;
    /*
        The onCreate method is called once the activity is loaded/activated by the user
        The content/ui is set to present the set layout in this case is "activity_two_fourty_pixel_stream_test"
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_two_fourty_pixel_stream_test);
         ...
         */
        videoView = findViewById(R.id.video_view_240p);
        ...
        /*
            ...
            specified
         */
        Uri uri = Uri.parse("https://firebasestorage.googleapis.com/v0/b/cs4501-streaming-application.appspot.com/o/240p.mp4?alt=media&token=0710c31d-ad4a-47b4-aab6-90d716d3cce6");
